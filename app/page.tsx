...
export default function HomePage() {
  return (
    <>
      ...
      <main>
        {/* ══════════════════ HERO ══════════════════ */}
        <section className="relative min-h-[75vh] sm:min-h-screen flex items-center overflow-hidden pt-32 sm:pt-20">
          <Crosshairs />
          ...
          <div className="max-w-7xl mx-auto px-6 w-full pt-2 pb-20 relative z-10">
            <div className="reveal">
              ...
              <p className="font-mono text-lg sm:text-xl mb-3 leading-relaxed">
                <span className="text-[#00e5ff]">// </span><span className="text-[#a8c4d8]">flat-rate websites for south african small businesses.</span>
              </p>
              <p className="font-mono text-lg sm:text-xl mb-8 leading-relaxed">
                <span className="text-[#00e5ff]">// </span><span className="text-[#a8c4d8]">starting from R3,500. no hidden fees.</span>
              </p>
              <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 mb-8">
                {["NO LOCK-IN CONTRACTS", "FILES ARE 100% YOURS", "LIVE IN 1–2 WEEKS"].map((chip) => (
                  <span key={chip} className="font-mono text-sm tracking-widest border border-[#00e5ff]/30 text-[#00e5ff]/60 px-4 py-2 text-center sm:text-left">
                    {chip}
                  </span>
                ))}
              </div>
              <p className="font-mono text-lg sm:text-xl leading-relaxed max-w-2xl">
                <span className="text-[#00e5ff]">// </span><span className="text-[#a8c4d8]">in tough economic times, your business deserves a professional, fantastic website - at a price that actually makes sense.</span>
              </p>
            </div>
          </div>
        ...
        <section id="services" className="relative py-16 px-6">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0 border border-[#00e5ff]/10">
              {[
                ...
                >
                  ...
                  <p className="text-[#a8c4d8] text-base leading-relaxed">{card.body}</p>
                </div>
              ))}
            </div>
            ...
            <div className="reveal mt-16 pt-16 border-t border-[#00e5ff]/10 max-w-2xl">
              ...
              <p className="text-[#a8c4d8] text-base sm:text-lg leading-relaxed mb-6">
              ...
              <p className="text-[#a8c4d8] text-base sm:text-lg leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 border border-[#00e5ff]/10">
              {[
                ...
                >
                  ...
                  <p className="text-[#a8c4d8] text-base leading-relaxed">{step.body}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="pricing" className="relative py-16 px-6">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <p className="reveal font-mono text-[#a8c4d8] text-sm tracking-wide mb-14">
              ...
              <div className="reveal reveal-delay-1 group border-2 border-[#00e5ff]/15 p-8 flex flex-col hover:border-[#00e5ff] hover:bg-[#ff1133]/10 transition-all duration-300">
                ...
                <div className="mb-1">
                  ...
                  <p className="font-mono font-bold text-4xl text-[#e8f4fd]">
                    ...
                    <span className="text-[#a8c4d8] text-lg group-hover:text-white transition-colors duration-300">/website</span>
                  </p>
                </div>
                <p className="font-mono text-[#a8c4d8] text-xs tracking-wide mb-0 group-hover:text-white transition-colors duration-300">Most sites land right here. We confirm before we start.</p>
                <div className="h-px bg-[#00e5ff]/10 my-6" />
                <ul className="flex flex-col gap-3 text-sm text-[#a8c4d8] group-hover:text-white flex-1 mb-8 transition-colors duration-300">
                  {[
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 border border-[#00e5ff]/10">
              {[
                ...
                >
                  ...
                  <p className="text-[#a8c4d8] text-base leading-relaxed">{item.body}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="reveal grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="flex flex-col justify-center">
                <p className="text-[#020c18]/70 text-base sm:text-lg leading-relaxed">
                  Yes and no. Instagram gets you seen; a website gets you hired. Posts disappear in hours. A website shows up in searches, stays live around the clock, and gives people a place to find you and get in touch. We build them at a flat rate, with no contracts and no surprises.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="contact" className="relative py-16 px-6 text-center">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="reveal">
              ...
              <p className="font-mono text-[#a8c4d8] italic mb-12 text-base leading-relaxed">
                WhatsApp us. Tell us about your business. No commitment, no pressure.
              </p>

              <a
                href="tel:+27613829267"
                className="block font-mono font-bold text-3xl sm:text-4xl lg:text-5xl text-[#00e5ff] tracking-widest mb-4 hover:text-white transition-colors duration-200"
              >
                061 382 9267
              </a>
              ...
              <a
                ...
                className="block font-mono text-[#a8c4d8] text-base tracking-wide mb-10 hover:text-[#00e5ff] transition-colors duration-200"
              >
              ...
              <p className="font-mono text-[#a8c4d8] text-sm tracking-widest">
                <a
                  href="mailto:oliver@neighbourhooddigital.co.za"
      ...
      <footer className="relative py-6 px-6 border-t border-[#00e5ff]/10">
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="font-mono text-[#a8c4d8] text-xs tracking-widest uppercase">
          ...
          <p className="font-mono text-[#a8c4d8] text-xs tracking-widest">
            // your website, sorted.
          </p>
        </div>
      </footer>
